...
export class EmployeeMasterComponent implements OnInit {
  ...
  editEmployee(item: any) {
    ...
    const selectEmployeeRole = this.roleList.find((id:any)=> id.roleName === item.selectEmployeeRole )
    this.emaployeeForm.controls.selectEmployeeRole.setValue(selectEmployeeRole)
    const selectEmployeeStatus = this.statusList.find((id:any)=> id.status === item.selectEmployeeStatus)
    this.emaployeeForm.controls.selectEmployeeStatus.setValue(selectEmployeeStatus)
